...
Vger is based on the concept of a [balanced metrics dashboard](http://focusedobjective.com/team-metrics-right/) that allows you to look at team performance from several different perspectives.
...
*   Click on ![](attachments/87624456/87624441.png) to see information about your performance on JIRA issues.

*   Click on ![](attachments/87624456/87624440.png) to see information about your performance on GitHub pull requests.
...
To present the `**Edit Work Types**` dialog, click on ![](attachments/87624456/87624450.png) next to the Work Types list in the top navigation bar.
...
To present the `**Edit Work States**` dialog, click on ![](attachments/87627384/87627352.png) in the top right corner of the Lead Times quadrant.
...
If you clicked on ![](attachments/87624456/87624441.png) to view JIRA issue performance, you can use the `**Work Types**` menu to further filter results. The charts will then show metrics only for the work types that you selected.

How can I see how much time is spent in different work states?
--------------------------------------------------------------

If you clicked on ![](attachments/87627384/87627559.png) to view JIRA issue performance, the `**Lead Times**` chart offers both an `**Overall**` view and a `**Detailed**` view. Used the `**Detailed**` view to see how lead time is distributed among different work states.
...
In the top control bar, click on ![](attachments/87627384/87627568.png) to enable or disable the tag view. When enabled, the tag view adds vertical lines to every chart, each representing the time of a tag recorded in the GitHub repo(s) for this project. Assuming that you use tags to mark releases and other significant baselines, this shows you what was happening in your project in the times between releases.
...
If you cannot to wait, click on ![](attachments/87627384/87627352.png) next to the project name in the top navigation bar, and click on the ![](attachments/87627384/89181809.png) button in the poped up window. ETL will be triggered manually and will be ready in 30 sec\-15 min depends on your project size.
...
        If you cannot to wait, click on ![](attachments/87627384/87627352.png) next to the Work Types list in the top navigation bar., and click on the ![](attachments/87627384/89181809.png) button the poped up window.
...
![](attachments/87627384/89168925.png)
...
![](images/icons/bullet_blue.gif) [Help.png](attachments/87627384/87627343.png) (image/png)  
![](images/icons/bullet_blue.gif) [Pencil.png](attachments/87627384/87627352.png) (image/png)  
![](images/icons/bullet_blue.gif) [jql.png](attachments/87627384/87627369.png) (image/png)  
![](images/icons/bullet_blue.gif) [jira.png](attachments/87627384/87627559.png) (image/png)  
![](images/icons/bullet_blue.gif) [Tag.png](attachments/87627384/87627568.png) (image/png)  
![](images/icons/bullet_blue.gif) [Warning.png](attachments/87627384/89168926.png) (image/png)  
![](images/icons/bullet_blue.gif) [Warning.png](attachments/87627384/89168925.png) (image/png)  
![](images/icons/bullet_blue.gif) [Screen Shot 2018\-04\-25 at 3.37.40 PM.png](attachments/87627384/89181809.png) (image/png)  